...
export default function LoginScreen() {
  ...
  async function handleLogin() {
    ...
    try {
      ...
      // ✅ Compte existant mais email pas encore vérifié : on renvoie un code et on redirige
      if (status === 403) {
        try {
          await client.post('/auth/send-code', { email });
        } catch {
          // si l'envoi échoue on redirige quand même, l'utilisateur pourra cliquer "Renvoyer le code"
        }
